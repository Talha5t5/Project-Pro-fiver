...
export default function LoginPage() {
  ...
  const onSubmit = async (data: LoginFormValues) => {
    try {
      ...
      toast({
        ...
        description: currentText.welcomeMessage,
        variant: "default",
      });
      ...
      toast({
        title: currentText.loginError,
        description: err instanceof Error ? err.message : currentText.loginError,
        variant: "destructive",
      });
    } finally {
      setIsLoading(false);
  ...
  const textContent = {
    ...
    en: {
      ...
      welcomeMessage: "Welcome to ProjectPro!"
    }
  };
